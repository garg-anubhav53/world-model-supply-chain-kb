...
| **ARBE (Arbe Robotics)** | Israel 4D imaging radar | AV — named Hirain L4-robotaxi + US Army wins | **WATCH (early-stage, binding gate showing time-decay) — dossier in companies/ARBE.md** |
| **ZENTEC (Zen Technologies)** | India defense-robotics (C-UAS + Bhairav quadruped stake) | named Indian MoD buyer | **WATCH (early-stage) — dossier in companies/ZENTEC.md** |
| **SMSH (Smart Shooter, TASE)** | Israel defense fire-control/target-acquisition | named US Army/USMC/Navy/UK MoD buyers | **WATCH (Fire 12) — dossier in companies/SMSH.md** |
| **POCI (Precision Optics)** | medical-robotics optics/endoscopes | near-certain buyer Procept BioRobotics (insourcing risk) | **WATCH (weak) — dossier in companies/POCI.md** |

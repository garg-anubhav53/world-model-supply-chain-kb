...
## Live candidates (see kb/pipeline.md for full ranked table; verified count as of Fire 87: 1 ranked WATCH [Seyond] + Guangdong Asensing/SOS Lab PENDING + HSAI PARKED outside the count, target 15 — table below still contains other stale rows beyond the ones fixed Fire 86/87, treat with caution until a full reconciliation)

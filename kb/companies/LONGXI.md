...
**Business fundamentals were last fully re-derived at Fire 72 (2026-07-11) and found clean:** AgiBot/智元 joint-bearing JV (85%-owned, ~¥8,000/robot core wrist/ankle-joint content) still active/core-exclusive on the high-value joints (though not sole-source overall — AgiBot keeps a parallel technical-exchange track with Changsheng Bearing on non-core content); FY2025 revenue decline (−24.31%) is a deliberate cut of low-margin trading volume, core bearing sales actually **+4.03% YoY**; the Q1-2026 reported net loss is entirely a mark-to-market artifact on an Industrial Securities equity stake, not core-business deterioration (operating gross margin actually rose to 41.09%). Humanoid-specific revenue remains tiny (~¥1.3M disclosed, sample-stage) — the JV is real but has NOT yet converted to a disclosed mass-production order. This is the standing bear case: the entire thesis remains an *option* on AgiBot reaching volume production, which the company itself still flags as materially uncertain.

**Verdict: PROMOTE to WATCH 5/8** (Gate 1 now clears on 3 consecutive closes below trigger + is a genuine de-rate — 12-month change still ~−29% to −34% even at the trigger price, not a chase; Gate 2 real/dated/core-exclusive on wrist-ankle joints but not sole-source; Gate 3 fails strictly today [<0.1% of revenue] but the option value is real given the exclusive JV; Gate 4 clean on the core bearing business, noisy/distracting mark-to-market on the securities book). **Caveat: given the price is genuinely oscillating right at the $800M/¥13.59 boundary (intraday back over on 07-16), the next fire MUST re-verify with a clean CLOSE-based 2-source pull before treating this as a durable promotion** — do not assume the flip is permanent off 3 data points alone during a volatile week. Binding gate for a further upgrade: an actual disclosed AgiBot order/revenue figure converting the JV from "small-batch sampling" to a real multiplier.
...
- 2026-07-11 is a Saturday; SSE closed, latest tradable print is Fri 2026-07-10 close. 2-source (fupanwang.com, investing.com, cross-checked cfi.cn): ¥14.55/share, +6.83% on the day, mkt cap ¥5.8135B — consistent with the Fire 56/57 baseline.
- **Distance to corrected cap (¥5.43B): ~7.0% over**, needs a ~6.5% price drop (to ~¥13.59) to clear. Notable: the 07-09 close of ¥13.62 (≈¥5.45B) was essentially AT the cap — Friday's +6.83% humanoid-sector-wide rally (which also pushed Dongfang Electric Heating up +6.99%) is exactly what pushed it back over. It was one down-day from flipping.
- **New disclosure:** a 2026-07-09 insider-buy filing — 6 executives incl. chairman 陈晋辉 bought 67,400 shares/¥909,372 (0.0169% of capital) — a mild confidence signal, not material. No change to the AgiBot causal link; 互动易 replies remain cautious (still R&D/small-batch sampling stage).
- **Verdict: stays PENDING, unchanged.** Still the KB's closest-to-flip name — recheck at next session close (Mon 2026-07-13).
- Sources: 600592.fupanwang.com, investing.com/equities/longxi-bearing, quote.cfi.cn/quote1300_600592.html (all 2026-07-10 close) · minichart.com.sg/2026/07/10/ (insider buys) · gelonghui.com/p/2141978 (互动易 reply).
...
## Fire 60 (2026-07-11) — Opus conviction-track deep dive. VERDICT: HOLD PENDING, score 5/8 — sharpened to a precise, actionable flip trigger.
**Fresh 2-source price check (Jul 10 close, latest session — Jul 11 is Saturday):** ¥14.55/share (+6.83% on the day), 399.55M shares → mkt cap ¥5.813B (StockAnalysis + Investing.com agree exactly). USD/CNY 6.781 (TradingEconomics, Jul 10) → **$857M, +7.0-7.1% over the ¥5.43B/$800M cap** — premium persists, in fact widened intraday off a robotics-sector rally.
**New finding: the name touched the flip line mid-week.** At the prior close (¥13.62, Jul 9) the cap was ¥5.442B = only +0.2% over — essentially AT the gate — before Friday's +6.83% pop pushed it back to +7.0%. **Exact flip price: ¥13.59/share** (¥5.43B ÷ 399.55M shares). Current ¥14.55 is only 6.6% above that line.
**Buyer relationship re-verified, sharper than "named buyer":** 85%-owned JV (福建龙溪智元机器人关节科技, signed March 2025) with AgiBot/Zhiyuan. Capture-rate clarified: **effectively exclusive on core wrist/ankle joints** (~¥8,000 content/robot) while AgiBot runs parallel technical exchange with others (e.g. Changsheng Bearing) on non-core joints — stronger than a generic 1-of-N. Won AgiBot's "Excellent Partner Award" Mar 2025; >75% domestic joint-bearing share. Caveat unchanged: no disclosed AgiBot-specific revenue (total robot-bearing orders >¥120M Q3-2025, all customers).
**Financials:** fortress balance sheet — net cash ¥1.22B (~21% of mkt cap), EV only ¥4.73B, profitable (¥168.6M FY2025 net income) — but core legacy business (construction/aero/auto bearings) is shrinking, revenue -24% YoY FY2025, -22% 9M2025. Robotics not yet offsetting.
**Price gate cleanly passes:** -34.84% over trailing 12 months, price below both 50-day (¥17.79) and 200-day (¥22.61) MAs — this is a name that has de-rated 35% off its Nov-2025 peak (PE was ~131x then, now ~42x TTM), not one that's running up.
**4 gates re-scored:** Size **0/2** (hard breach, +7.0%). Buyer **2/2** (strong, specific, JV-backed). Financial health **1/2** (fortress cash, but contracting legacy revenue). Price **2/2** (well below MAs, not chasing). **Total 5/8.**
**Actionable trigger for next fire:** promote to WATCH on any daily close ≤¥13.59/share. Given the structural downtrend (below both MAs), drift is toward the cap, not away from it — check every session if feasible, otherwise every fire without exception until it flips or the JV relationship is disclosed as revenue.
Sources: stockanalysis.com/quote/SHA/600592 (Jul 10 2026), investing.com/equities/longxi-bearing, tradingeconomics.com/china/currency (Jul 10 2026), Eastmoney caifuhao 2026-02-18 & 2025-07-09, Sohu 2025-11-22.

**Fire 77 update (2026-07-16): confirmed close UNCHANGED at ¥13.45 (2026-07-15), promotion still durable — but a live intraday flag for tomorrow's close.** 2-source confirmation (Tencent/gtimg + Eastmoney push2delay) both show the last SETTLED close as ¥13.45, mkt cap ~$793.7M, matching Fire 76 almost exactly — still under the $800M cap, still below the ¥13.59 trigger. **However, at the moment of this fire's data pull (same day, 07-16, ~14:27 Beijing time, ~30min before close), the stock was trading INTRADAY at ¥13.62-13.63 (session range ¥13.22-13.85) — above the ¥13.59 trigger.** If today's close settles at or above ¥13.62, that would both (a) break the 3-consecutive-close-below-trigger streak and (b) push market cap to ~$803-804M, back over the $800M hard cap — reversing this fire's "durable" framing. This is NOT yet a confirmed change (per the standing close-based-only rule) — mandatory next-fire task: pull the actual 2026-07-16 close before treating the WATCH status as stable. No change to score (5/8) or business facts this fire.

**Fire 78 update: REVERSAL confirmed.** The 2026-07-16 close settled at ¥13.66-13.67 (2-source), breaking back above the ¥13.59 trigger and pushing mkt cap to ~$780-806M (at/above the $800M cap) — the 3-consecutive-close streak (07-13/14/15) is broken. Reverts WATCH→PENDING. Must re-earn a fresh consecutive-close streak (recommend 5 closes, not 3, given this is now a 2nd round-trip through the trigger) before re-promotion. Score holds 5/8, no business-fundamentals change (AgiBot JV still active/sample-stage).

**Fire 79 update (2026-07-16 data, price-refresh scout): full 2-week close history reconstructed, confirms the boundary is genuinely whipsawing, not noisy-but-settled.** Daily closes: Jul 9 ¥13.62 (brush, above) → Jul 10 ¥14.55 (limit-up +9.1% on insider open-market buying disclosure, above) → Jul 13 ¥13.47 (below) → Jul 14 ¥13.24 (below) → Jul 15 ¥13.45 (below, 3rd consecutive) → Jul 16 ¥13.66 (confirmed break-back, above). This means the stock has now crossed the ¥13.59 line **three separate times in eight trading sessions** (Jul 9 brush, Jul 13 cross-below, Jul 16 cross-above) — the most dynamic stretch since tracking began. Current status unchanged from Fire 78: PENDING, 0 consecutive closes below trigger as of 07-16, price ¥13.66 (investing.com/Google Finance/TradingView 3-source agreement), mkt cap $779-803M. Reinforces the standing recommendation: do not re-promote on fewer than 5 consecutive closes below ¥13.59 given the boundary has proven genuinely unstable, not a one-off wobble. No score change (5/8), no business-fundamentals change.

**Fire 80 update (2026-07-16, WILDCARD FIRE, independently re-confirmed via Sina Finance historical API, 2-source cross-check with Tencent qt.gtimg.cn): the 5-consecutive-close bar has STILL not been met — pattern continues to whipsaw, not settle.** Full last-10-session close reconstruction: 07-03 ¥16.12 · 07-06 ¥15.08 · 07-07 ¥14.46 · 07-08 ¥13.79 · 07-09 ¥13.62 · 07-10 ¥14.55 · **07-13 ¥13.47 · 07-14 ¥13.24 · 07-15 ¥13.45** (3 consecutive below-¥13.59) · **07-16 ¥13.66** (back above, resets the counter — matches Fire 79's finding, independently reproduced). Mkt cap unchanged ~$779-803M at flat price. New supplementary fact: AgiBot hit its 15,000th robot produced 2026-06-28 (G2 industrial embodied line); on 2026-07-09 six Longxi directors/senior managers jointly bought 67,400 shares (~¥909,372, 0.0169% of share capital) — a mild insider-buying signal, not material to the technical thesis. **Status: still PENDING, still 0/5 on the consecutive-close bar. This is now the 3rd independent confirmation (Fire 78, 79, 80) that the ¥13.59 line does not hold for more than 3 sessions at a stretch — treat the "5 consecutive closes" rule as durable, not overly conservative.** No score change (5/8), no business-fundamentals change.
